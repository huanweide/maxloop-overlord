...
本版为「通用化 + 数据具象化」版：**确认它是面向所有人的通用 skill（不绑定任何项目/语言/框架），并把「提升作用」量化成 4 个必记指标。**
...
| 效果度量小节（七之三）+ effectiveness-metrics.md | 新增·实质 | 把"提升作用"具象为 4 指标，每轮必填，杜绝"感觉更稳了"式玄学 |
| Chair 清单加「效果度量已填」项 | 新增 | 把度量纳入落地必勾 |
